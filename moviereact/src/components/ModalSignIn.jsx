  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <div className="signin">
        ...
        <div className="pb_41">Password</div>
        <div>
          <input
            className="form-control input_email"
            type="password"
        ...
        <div className="d-flex flex-column">
          <button type="button" className="btn btn-warning mt_24 btn_signin">
            Sign In
          </button>
        </div>
      </div>
      ...
      <div className="signin">
        ...
        <div className="form-check form-switch d-flex justify-content-center align-items-center mt_24">
          <input
            ...
            style="margin: 0;"
          />
          <label className="form-check-label or_text" for="flexSwitchCheckDefault">
            Keep me signed in
          </label>
        </div>
        <div className="d-flex flex-column">
        ...
        <div className="or_text mt_24" style="text-align: center;">
          or
        </div>
        <div className="d-flex flex-column mt_24" style="gap: 12px;">
          <button type="button" className="btn btn-light btn-sosmed">
            <svg
